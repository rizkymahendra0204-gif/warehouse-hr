        ...
        <!-- CONTENT AREA -->
            ...
            <div class="form-container">
                ...
                <div class="d-flex justify-content-between align-items-center form-header">
                    <h6 class="m-7 fw-bold" style="font-size: 16px;">Form Request Seragam</h6>
                    <h3 class="logo-central">CENTRAL</h3>
                </div>
                ...
                <div class="section-box">
                    ...
                    <!-- Pilih Jenis Seragam (Font Diperkecil) -->
                    <div class="mb-4">
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control form-control-sm" value="Rp 0" readonly>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row mt-4 pt-3 border-top">
                        ...
                        <div class="col-4 text-start fw-bold text-danger" style="font-size: 14px;">Rp 0</div>
                    </div>
                </div>
                ...
                <div class="section-box mb-2">
                    ...
                    <div class="d-flex gap-4 mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="metode_bayar" id="transfer" value="transfer">
                            <label class="form-check-label fw-bold" for="transfer" style="font-size: 14px; font-weight: 600;">Transfer</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="metode_bayar" id="potongOmzet" value="potong_omzet">
