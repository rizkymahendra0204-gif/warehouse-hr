...
// =========================================================================
// 1. CORE CONFIGURATION & INTERNATIONALIZATION (I18N)
// =========================================================================

/**
 * Helper fungsi kamus bahasa (I18N)
 */
...
/**
 * Pemetaan Konfigurasi Global Aplikasi
 */
...
// =========================================================================
// 2. GLOBAL STATE & UTILITY HELPERS
// =========================================================================
...
/**
 * Kunci tombol submit/proses transaksi saat data berubah
 */
...
/**
 * Menampilkan Alert Dinamis (Toast/Floating)
 */
...
/**
 * Mapping Data Audit Modal Warehouse Management
 */
...
// =========================================================================
// 3. BARCODE PARSER & DYNAMIC CARDS ENGINE
// =========================================================================

/**
 * Parsing String Barcode (9 Digit Format)
 */
...
function processAutoScan(barcodeVal) {
  ...
  // Pengecekan Batas Scan berdasarkan Tiket Request
...
/**
 * Generasi Kartu Item Transaksi Utama
 */
...
/**
 * Generasi Baris Item Return (Pengembalian Barang)
 */
...
// =========================================================================
// 4. TRANSACTION VALIDATION ENGINE (DATABASE & TICKET CHECK)
// =========================================================================
...
async function validateAllItems() {
  ...
  // Lapis 1: Cek Konsistensi Gender (Pria / Wanita)
  ...
  // Lapis 2: Pengecekan Kesesuaian Tiket Request
  if (window.transactionData && window.transactionData.isAuto) {
...
// =========================================================================
// 5. DOM READY EVENT LISTENERS & INITIALIZERS
// =========================================================================

$(document).ready(function () {
  console.log("✅ scripts.js berhasil dimuat!");

  // --- 5.1 LAYOUT & NAVIGATION HANDLERS ---
  ...
  // --- 5.2 FORM & ITEM CONTAINER HANDLERS ---
  ...
  // --- 5.4 DYNAMIC DROPDOWNS (GENDER/TIPE/UKURAN) ---
  $(document).on(
    "change",
  ...
  // --- 5.6 BATCH INVENTORY SAVING (PRINT & EXPORT REQUIREMENT) ---
  let isPrinted = false;
...
// =========================================================================
// 6. MODAL & USER MANAGEMENT HANDLERS
// =========================================================================
